...
<table class="table table-hover">
    ...
    <tr>
        ...
        <td>{{ $item->phoneno }}</td>
        <td>
            <a href="/Admin-HR/{{ $item->id }}" style="text-decoration: none;">
                <button class="btn btn-primary" type="submit" style="margin-right: 11px;">Edit</button>
            </a>
...
<div class="row" style="margin: 0px;background: white;padding: 20px;">
    <div class="col-5">
